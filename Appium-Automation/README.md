...
Built as a hands-on project to practice mobile test automation fundamentals: Page Object Model design, Appium driver configuration, and TestNG-based test organization.
